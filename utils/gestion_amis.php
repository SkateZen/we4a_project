...
function AjoutAmi(){
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["ajout_ami"])){
        ...
        $query = "INSERT INTO `relation`(`id_relation`, `id_utilisateur1`, `id_utilisateur2`, `statut` ) VALUES (NULL, '$userID', '$id_ami', 'en attente')";
...
function ShowAmis(){
    ...
    //$query = "SELECT * FROM `utilisateur` WHERE id_utilisateur IN (SELECT id_utilisateur2 FROM `relation` WHERE id_utilisateur1 = '$userID' AND statut = 'ami')";
